...
export function AdminFinancialContent() {
  ...
  /** Text/number edits commit on blur so typing doesn't refetch on every keystroke. */
          ...
          <div className="space-y-5">
            ...
            <section className="bg-white rounded-2xl border shadow-sm p-5 space-y-4">
              ...
              <p className="text-sm text-gray-500">
                Event venues are listed as a directory — guests contact them directly, so there
                is no booking commission. Hosts pay by how many venues they list.
              </p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-[11px] text-gray-400">
                  Leave “Max venues” empty for an unlimited tier. A host is charged the cheapest
                  tier that covers their number of event listings.
                </p>
              </div>
