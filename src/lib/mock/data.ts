export const STAYS = [
  ...
  },
  {
    ...
    type: "venue" as const,
    parentCategory: "Events",
    subcategory: "Farmhouse Gatherings",
    instantBook: true,
